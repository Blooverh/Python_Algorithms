...
class Solution:
    ...
    def isSameNode(self, leftroot: TreeNode, rightroot: TreeNode) -> bool:
        ...
        return self.isSameNode(leftroot.left, rightroot.right) and self.isSameNode(leftroot.right, rightroot.left)